      ...
      return (
        <div className="absolute inset-0 bg-black min-h-full">
          <div className="bg-black p-8 grid gap-4">
            <div>
              <button onClick={() => setShowAllPhotos(false)} className="fixed flex gap-1 py-2 px-4 bg-red-300 rounded-3xl right-12 top-8 shadow shadow-gray-500">
  ...
  return (
    <div className="mt-4 bg-gray-200 -mx-8 px-8 py-8">
      ...
      <div className="relative">
        ...
        <button onClick={() => setShowAllPhotos(true)} className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-lg shadow-md shadow-gray-500">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
